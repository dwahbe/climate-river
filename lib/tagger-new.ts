...
export const CATEGORIES = [
  ...
  },
  {
    ...
    patterns: [
      ...
      /(ai|artificial intelligence|satellite|sensor|monitoring|app|platform)/i,
      /(solar|wind|renewable|grid|electricity|power|nuclear|energy storage)/i,
    ],
  },
  {
    slug: 'research',
    ...
    patterns: [
      /(study|research|scientist|data|analysis|findings|evidence)/i,
      /(temperature|co2|carbon dioxide|methane|greenhouse gas)/i,
      /(ipcc|climate model|peer review|journal|report|science|scientific)/i,
    ],
  },
  {
    slug: 'business',
  ...
  },
  {
    ...
    patterns: [
      /(justice|equity|environmental justice|community|indigenous)/i,
