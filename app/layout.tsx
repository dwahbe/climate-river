      ...
      <body className="min-h-full bg-zinc-50 text-zinc-900 antialiased overflow-x-hidden overscroll-x-none">
        ...
        <footer className="border-t border-zinc-100 mt-12">
          <div className="mx-auto max-w-5xl px-4 sm:px-6 py-6 flex flex-wrap items-center gap-x-5 gap-y-2 text-xs text-zinc-400">
            <Link
              href="/"
              className="flex items-center gap-1.5 no-underline mr-1"
            >
            ...
            <Link
              href="/categories"
              className="hover:text-zinc-600 no-underline"
            >
              Categories
            </Link>
            <Link href="/about" className="hover:text-zinc-600 no-underline">
              About
            </Link>
            <Link href="/sources" className="hover:text-zinc-600 no-underline">
              Sources
            </Link>
            <a href="/feed.xml" className="hover:text-zinc-600 no-underline">
              RSS
            </a>
          </div>
        </footer>
